                            ...
                            @forelse($orders as $order)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        @else
                                            <p class="text-gray-900 whitespace-no-wrap">{{ $order->guest_name }} (Guest)</p>
                                            <p class="text-gray-500 text-xs">{{ $order->guest_email }}</p>
                                        @endif
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">${{ $order->total_amount }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <span
